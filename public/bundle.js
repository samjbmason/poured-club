...
/***/ function(module, exports, __webpack_require__) {
	...
	var Redux = __webpack_require__(168);
	var ReactRedux = __webpack_require__(181);
	var Provider = ReactRedux.Provider;
	var createStore = Redux.createStore;

	var Router = __webpack_require__(190).Router;
	var browserHistory = __webpack_require__(190).browserHistory;
	var routes = __webpack_require__(249);

	var shop = __webpack_require__(251);
	var initialStore = __webpack_require__(252);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = __webpack_require__(250);
	var IndexComponent = __webpack_require__(253);
	var CheckoutComponent = __webpack_require__(259);
...
/***/ function(module, exports) {
	...
	var shop = function shop(state, action) {
	  switch (action.type) {
	    case 'ADD_ITEM':
	      return {};
	    default:
...
/***/ function(module, exports) {
	...
	// This object represents the store and its stock, this is probably not a great way to store but for now let's do it
	var products = { inventory: [{
	    sku: 'lgtm-badge',
	    name: 'lgtm badge',
	    description: '25mm enamel pin badge',
	    price: '£6'
	  }, {
	    sku: 'plus-one-badge',
	    name: '+1 badge',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var connect = __webpack_require__(181).connect;
	var Product = __webpack_require__(254);
	...
	var Index = React.createClass({
	  ...
	  renderProducts: function renderProducts() {
	    return this.props.inventory.map(function (product) {
	      return React.createElement(Product, _extends({ key: product.sku }, product));
	    });
	  },
	  render: function render() {
	    return React.createElement(
